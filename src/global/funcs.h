...
#define Camera_ShiftClamp ((int32_t __cdecl (*)(struct GAME_VECTOR *pos, int32_t clamp))0x004114E0)
#define Camera_Combat ((void __cdecl (*)(struct ITEM_INFO *item))0x00411680)
...
#define Camera_LoadCutsceneFrame ((void __cdecl (*)(void))0x004126A0)
...
#define Item_GetAnimChange ((int32_t __cdecl (*)(struct ITEM_INFO *item, ANIM_STRUCT *anim))0x00414A60)
...
#define Room_GetHeight ((int32_t __cdecl (*)(struct FLOOR_INFO *floor, int32_t x, int32_t y, int32_t z))0x00414E80)
...
#define Room_GetCeiling ((int32_t __cdecl (*)(struct FLOOR_INFO *floor, int32_t x, int32_t y, int32_t z))0x00415930)
...
#define GetFrames ((int32_t __cdecl (*)(struct ITEM_INFO *item, int16_t *frmptr[], int32_t *rate))0x0041BF90)
#define GetBoundsAccurate ((int16_t *__cdecl (*)(struct ITEM_INFO *item))0x0041C030)
...
#define LaraAboveWater ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427580)
#define LookUpDown ((void __cdecl (*)(void))0x00427720)
#define LookLeftRight ((void __cdecl (*)(void))0x00427790)
#define ResetLook ((void __cdecl (*)(void))0x00427810)
#define lara_as_walk ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004278A0)
#define lara_as_run ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427930)
#define lara_as_stop ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427A80)
#define lara_as_forwardjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427BD0)
#define lara_as_fastback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427CB0)
#define lara_as_turn_r ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427D10)
#define lara_as_turn_l ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427DA0)
#define lara_as_death ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427E30)
#define lara_as_fastfall ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427E50)
#define lara_as_hang ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427E90)
#define lara_as_reach ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427EF0)
#define lara_as_splat ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427F10)
#define lara_as_compress ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00427F20)
#define lara_as_back ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428030)
#define lara_as_null ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004280C0)
#define lara_as_fastturn ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004280D0)
#define lara_as_stepright ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428120)
#define lara_as_stepleft ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004281A0)
#define lara_as_slide ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428220)
#define lara_as_backjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428250)
#define lara_as_rightjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004282A0)
#define lara_as_leftjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004282E0)
#define lara_as_upjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428320)
#define lara_as_fallback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428340)
#define lara_as_hangleft ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428370)
#define lara_as_hangright ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004283B0)
#define lara_as_slideback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004283F0)
#define lara_as_pushblock ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428410)
#define lara_as_ppready ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428440)
#define lara_as_pickup ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428470)
#define lara_as_pickupflare ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004284A0)
#define lara_as_switchon ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428500)
#define lara_as_usekey ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428540)
#define lara_as_special ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428570)
#define lara_as_swandive ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428590)
#define lara_as_fastdive ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004285C0)
#define lara_as_waterout ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428620)
#define lara_as_wade ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428640)
#define lara_as_deathslide ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428710)
#define extra_as_breath ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004287B0)
#define extra_as_yetikill ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428800)
#define extra_as_sharkkill ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428850)
#define extra_as_airlock ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004288F0)
#define extra_as_gongbong ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428910)
#define extra_as_dinokill ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428930)
#define extra_as_pulldagger ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428990)
#define extra_as_startanim ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428A50)
#define extra_as_starthouse ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428AA0)
#define extra_as_finalanim ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428B50)
#define LaraFallen ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428C00)
#define LaraCollideStop ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428C60)
#define lara_col_walk ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428D20)
#define lara_col_run ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00428EC0)
#define lara_col_stop ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429040)
#define lara_col_forwardjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004290D0)
#define lara_col_fastback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004291B0)
#define lara_col_turn_r ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429270)
#define lara_col_turn_l ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429310)
...
#define lara_col_reach ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429570)
#define lara_col_splat ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429600)
...
#define lara_col_leftjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429980)
#define lara_col_upjump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004299B0)
#define lara_col_fallback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429AD0)
#define lara_col_hangleft ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429B60)
#define lara_col_hangright ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429BA0)
#define lara_col_slideback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429BE0)
#define lara_col_roll ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429C10)
#define lara_col_roll2 ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429C30)
#define lara_col_special ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429CC0)
#define lara_col_swandive ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429D80)
#define lara_col_fastdive ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429DF0)
#define lara_col_wade ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429E70)
#define lara_default_col ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00429FE0)
#define lara_col_jumper ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A020)
#define GetLaraCollisionInfo ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A0A0)
#define lara_slide_slope ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A0E0)
#define LaraHitCeiling ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A1D0)
#define LaraDeflectEdge ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A240)
#define LaraDeflectEdgeJump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A2C0)
#define LaraSlideEdgeJump ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A440)
#define TestWall ((int32_t __cdecl (*)(struct ITEM_INFO *item, int32_t front, int32_t right, int32_t down))0x0042A530)
#define LaraTestHangOnClimbWall ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A640)
#define LaraTestClimbStance ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A750)
#define LaraHangTest ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042A810)
#define LaraTestEdgeCatch ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll, int32_t *edge))0x0042AB70)
#define LaraTestHangJumpUp ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042AC20)
#define LaraTestHangJump ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042AD90)
#define TestHangSwingIn ((int32_t __cdecl (*)(struct ITEM_INFO *item, PHD_ANGLE angle))0x0042AF30)
#define TestLaraVault ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042AFF0)
#define TestLaraSlide ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042B2E0)
#define LaraFloorFront ((int16_t __cdecl (*)(struct ITEM_INFO *item, PHD_ANGLE ang, int32_t dist))0x0042B410)
#define LaraLandedBad ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042B490)
#define GetLaraJointAbsPosition ((void __cdecl (*)(struct PHD_VECTOR *vec, int32_t joint))0x0042B550)
#define GetLJAInt ((void __cdecl (*)(struct ITEM_INFO *item, struct PHD_VECTOR *vec, int16_t *frame1, int16_t *frame2, int32_t frac, int32_t rate))0x0042B8E0)
...
#define lara_as_climbleft ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042D850)
#define lara_as_climbright ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042D890)
#define lara_as_climbstnc ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042D8D0)
#define lara_as_climbing ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042D950)
#define lara_as_climbend ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042D970)
#define lara_as_climbdown ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042D990)
#define lara_col_climbleft ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042D9B0)
#define lara_col_climbright ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042DA10)
#define lara_col_climbstnc ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042DA70)
...
#define LaraCheckForLetGo ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x0042DF70)
#define LaraTestClimb ((int32_t __cdecl (*)(int32_t x, int32_t y, int32_t z, int32_t xfront, int32_t zfront, int32_t item_height, int16_t item_room, int32_t *shift))0x0042E020)
#define LaraTestClimbPos ((int32_t __cdecl (*)(struct ITEM_INFO *item, int32_t front, int32_t right, int32_t origin, int32_t height, int32_t *shift))0x0042E290)
#define LaraDoClimbLeftRight ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll, int32_t result, int32_t shift))0x0042E360)
#define LaraTestClimbUpPos ((int32_t __cdecl (*)(struct ITEM_INFO *item, int32_t front, int32_t right, int32_t *shift, int32_t *ledge))0x0042E450)
...
#define LaraControl ((void __cdecl (*)(int16_t item_num))0x004302E0)
#define AnimateLara ((void __cdecl (*)(struct ITEM_INFO *item))0x00430970)
#define UseItem ((void __cdecl (*)(int16_t object_num))0x00430C70)
#define LaraCheatGetStuff ((void __cdecl (*)(void))0x00430E30)
#define ControlLaraExtra ((void __cdecl (*)(int16_t item_num))0x00430EF0)
#define InitialiseLaraLoad ((void __cdecl (*)(int16_t item_num))0x00430F10)
#define InitialiseLara ((void __cdecl (*)(int32_t type))0x00430F40)
#define InitialiseLaraInventory ((void __cdecl (*)(int32_t level_num))0x00431200)
#define LaraInitialiseMeshes ((void __cdecl (*)(int32_t level_num))0x00431570)
#define LaraSurface ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431670)
#define lara_as_surfswim ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004317D0)
#define lara_as_surfback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431840)
#define lara_as_surfleft ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004318A0)
#define lara_as_surfright ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431900)
#define lara_as_surftread ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431960)
#define lara_col_surfswim ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431A50)
#define lara_col_surfback ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431A90)
#define lara_col_surfleft ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431AC0)
...
#define LaraSurfaceCollision ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431B40)
#define LaraTestWaterStepOut ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431C40)
#define LaraTestWaterClimbOut ((int32_t __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431D30)
#define LaraUnderWater ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00431F50)
#define SwimTurn ((void __cdecl (*)(struct ITEM_INFO *item))0x00432180)
#define lara_as_swim ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432210)
#define lara_as_glide ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432280)
#define lara_as_tread ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432300)
#define lara_as_dive ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432390)
#define lara_as_uwdeath ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x004323B0)
#define lara_as_waterroll ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432410)
#define lara_col_swim ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432420)
#define lara_col_uwdeath ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432440)
#define GetWaterDepth ((int32_t __cdecl (*)(int32_t x, int32_t y, int32_t z, int16_t room_num))0x004324A0)
#define LaraTestWaterDepth ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432640)
#define LaraSwimCollision ((void __cdecl (*)(struct ITEM_INFO *item, struct COLL_INFO *coll))0x00432710)
#define LaraWaterCurrent ((void __cdecl (*)(struct COLL_INFO *coll))0x00432870)
...
#define PlaySoundEffect ((void __cdecl (*)(uint32_t, struct PHD_3DPOS *, uint32_t))0x0043F3C0)
#define StopSoundEffect ((void __cdecl (*)(int32_t))0x0043F860)
...
#define S_CDVolume ((void __cdecl (*)(DWORD volume))0x004556B0)
