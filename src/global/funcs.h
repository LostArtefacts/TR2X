...
#define Output_DrawPolyTrans ((void __cdecl (*)(const int16_t *obj_ptr))0x00402B50)
#define Output_DrawPolyGouraud ((void __cdecl (*)(const int16_t *obj_ptr))0x00402B90)
#define Output_DrawPolyGTMap ((void __cdecl (*)(const int16_t *obj_ptr))0x00402BD0)
...
#define Output_InsertObjectGT4 ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x00405F20)
#define Output_InsertObjectGT3 ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x00406980)
#define Output_XYGClipper ((int32_t __cdecl (*)(int32_t vtx_count, struct VERTEX_INFO *vtx))0x00407200)
#define Output_InsertObjectG4 ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x00407630)
#define Output_InsertObjectG3 ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x00407A10)
...
#define Output_InsertObjectGT4_ZBuffered ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x00409300)
#define Output_InsertObjectGT3_ZBuffered ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x004093A0)
#define Output_InsertObjectG4_ZBuffered ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x00409450)
#define Output_DrawPoly_Gouraud ((void __cdecl (*)(int32_t vtx_count, int32_t red, int32_t green, int32_t blue))0x004097F0)
#define Output_InsertObjectG3_ZBuffered ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x004098F0)
...
#define Output_InsertObjectGT4_Sorted ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x0040AC80)
#define Output_InsertObjectGT3_Sorted ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x0040AD10)
#define Output_InsertObjectG4_Sorted ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x0040ADB0)
...
#define Output_InsertObjectG3_Sorted ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t num, enum SORT_TYPE sort_type))0x0040B370)
...
#define Output_InsertRoomSprite ((int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t vtx_count))0x0040C3B0)
...
#define Output_TransA ((void __fastcall (*)(int32_t y0, int32_t y1, BYTE depthQ))0x00457335)
#define Output_GourA ((void __fastcall (*)(int32_t y0, int32_t y1, BYTE colorIdx))0x0045746F)
#define Output_GTMapA ((void __fastcall (*)(int32_t y0, int32_t y1, BYTE *texPage))0x004575CF)
