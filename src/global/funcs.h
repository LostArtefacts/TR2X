...
#define Output_InsertGT4_ZBuffered ((void __cdecl (*)(const struct PHD_VBUF *vtx0, const struct PHD_VBUF *vtx1, const struct PHD_VBUF *vtx2, const struct PHD_VBUF *vtx3, const struct PHD_TEXTURE *texture))0x00408EB0)
...
#define Output_InsertRoomSprite ((const int16_t *__cdecl (*)(const int16_t *obj_ptr, int32_t vtx_count))0x0040C3B0)
...
#define S_InsertBackPolygon ((void __cdecl (*)(int32_t x1, int32_t y1, int32_t x2, int32_t y2))0x00450F30)
